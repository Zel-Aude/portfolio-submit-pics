...
public final class HandlePageBean {

	//1ページに表示するレコード数の最大値
	private static final int MAX_PAGE_RECORDS = 10;
	//一度に読み込むページ数
	private static final int LOAD_PAGE_VALUE = 2;
	...
	private static final class HandlePageBeanHolder {
		private static final HandlePageBean INSTANCE = new HandlePageBean();
	}

	private HandlePageBean() {}

	public static HandlePageBean getInstance() {
		return HandlePageBeanHolder.INSTANCE;
	}
